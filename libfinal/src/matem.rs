...
impl PVector4 {
    ...
    pub fn copy(&self) -> PVector4 {
        pvector4(self.x, self.y, self.z, self.w)
    }

    // Suma a este otro vector
    pub fn add(&mut self, b: &PVector4) {
        self.x += b.x;
        self.y += b.y;
        self.z += b.z;
        self.w += b.w;
    ...
    // NO ESTOY SEGURO
    pub fn lerp(&mut self, vector: PVector4, amt: f32) {
        self.x = (1.0 - amt) * self.x + amt * vector.x;
        self.y = (1.0 - amt) * self.y + amt * vector.y;
    ...
    // Distancia entre este vector y otro
    pub fn dist(&mut self, b: &PVector4) -> f32 {
        let x = self.x - b.x;
        let y = self.y - b.y;
        let z = self.z - b.z;
        ((x * x) + (y * y) + (z * z)).sqrt()
    ...
    pub fn sub_s(a: &PVector4, b: &PVector4) -> PVector4 {
        pvector4(a.x - b.x, a.y - b.y, a.z - b.z, 0.0)
    }
    ...
    pub fn sub(&mut self, b: &PVector4) {
        self.x -= b.x;
        self.y -= b.y;
        self.z -= b.z;
    }
